...
export default function Home() {
  ...
  const handleSearch = async () => {
    ...
    setDiploma({ ...MOCK_DIPLOMA, studentAddress: addr })
    setLoading(false)
  }
    ...
    <main className="page-wrapper" style={{ maxWidth: 680 }}>
      ...
      <div style={{ marginTop: 60, padding: 24, background: '#F8F9FD', borderRadius: 14, border: '1px solid #E2E7F4' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }}>
          {[
            { Icon: FileTextIcon,    title: 'PDF sur IPFS',          desc: "Le diplôme officiel est stocké de façon permanente sur le réseau décentralisé IPFS." },
            ...
            { Icon: CheckCircleIcon, title: 'Vérification publique', desc: "N'importe qui peut vérifier l'authenticité d'un diplôme en quelques secondes, sans intermédiaire." },
          ].map(({ Icon, title, desc }) => (
